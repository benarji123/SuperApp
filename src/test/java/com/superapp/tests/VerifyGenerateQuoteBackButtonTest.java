...
public class VerifyGenerateQuoteBackButtonTest extends BaseClass
{
	...
	public void verifyGenerateQuoteBackButton(HashMap<String, String> data) throws InterruptedException
	{
		...
		generateQuotePage.searchFuntionality();
