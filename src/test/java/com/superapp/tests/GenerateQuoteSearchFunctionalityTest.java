...
public class GenerateQuoteSearchFunctionalityTest extends BaseClass
{
	...
	public void verifySearchButton(HashMap<String, String> data) throws InterruptedException
	{
