...
public class VerifyAddNewLeadQuickLinkTest extends BaseClass
{
	...
	public void clickOnAddNewLeadQuickLinkTest(HashMap<String, String> data) throws InterruptedException
	{
		...
		Assert.assertEquals("Add CAT LMS", vymoPage.validateAddCATLMSHeaderNavigation());
