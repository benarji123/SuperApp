...
public class GenerateQuoteExitButtonValidationTest extends BaseClass
{
	...
	public void generateQuoteExitButtonValidationTest(HashMap<String, String> data) throws InterruptedException
	{
		...
		generateQuotePage.exitGenerateQuote();
