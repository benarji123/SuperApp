...
public class ContinueComparePlanTest extends BaseClass
{
	...
	public void continueComparePlanTest(HashMap<String, String> data) throws InterruptedException
	{
		...
		comparePlanPage.continueComparePlan();
