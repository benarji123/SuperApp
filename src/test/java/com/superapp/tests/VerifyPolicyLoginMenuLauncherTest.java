...
public class VerifyPolicyLoginMenuLauncherTest extends BaseClass
{
	...
	MenuBottomLauncherNavigationPage policyLoginMenuLauncher=null;
	PolicyLoginPage policyLoginPage=null;

	@Record(author = "Narada")
	@Test(dataProvider = "Datadriven")
	public void policyLoginMenuLauncherTest(HashMap<String, String> data) throws InterruptedException
	{
		...
		policyLoginMenuLauncher=new MenuBottomLauncherNavigationPage(adriver);
		...
		policyLoginMenuLauncher.policyLoginLauncher();
