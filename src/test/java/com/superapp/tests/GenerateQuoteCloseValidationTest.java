...
public class GenerateQuoteCloseValidationTest extends BaseClass
{
	...
	public void generateQuoteCloseValidationTest(HashMap<String, String> data) throws InterruptedException
	{
